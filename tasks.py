...
#     task(name = 'Select/VGG11/bin-40x',
#             task_type = 'binary',
#             net_class = networks.VGG11,
...
#     task(name = 'Select/VGG11/bin-100x',
#             task_type = 'binary',
#             net_class = networks.VGG11,
#             dataset_class = dataset.BreaKHis,
#             batch_size = 16,
...
#     task(name = 'Select/VGG11/bin-200x',
#             task_type = 'binary',
#             net_class = networks.VGG11,
#             dataset_class = dataset.BreaKHis,
#             batch_size = 16,
...
#     task(name = 'Select/VGG11/bin-400x',
#             task_type = 'binary',
#             net_class = networks.VGG11,
#             dataset_class = dataset.BreaKHis,
#             batch_size = 16,
...
#             magnification = 400),
    ...
    task(name = 'Select/VGG11/sub-40x',
            task_type = 'subtype',
            net_class = networks.VGG11,
            dataset_class = dataset.BreaKHis,
            batch_size = 16,
    ...
    task(name = 'Select/VGG11/sub-100x',
            task_type = 'subtype',
            net_class = networks.VGG11,
            dataset_class = dataset.BreaKHis,
            batch_size = 16,
    ...
    task(name = 'Select/VGG11/sub-200x',
            task_type = 'subtype',
            net_class = networks.VGG11,
            dataset_class = dataset.BreaKHis,
            batch_size = 16,
    ...
    task(name = 'Select/VGG11/sub-400x',
            task_type = 'subtype',
            net_class = networks.VGG11,
            dataset_class = dataset.BreaKHis,
            batch_size = 16,
